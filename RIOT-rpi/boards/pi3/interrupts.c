...
#include "bcm2837_intc.h"
static INTERRUPT_VECTOR g_VectorTable[BCM2837_INTC_TOTAL_IRQ];
...
static volatile BCM2837_INTC_REGS * const pRegs = (BCM2837_INTC_REGS *) (BCM2837_BASE_INTC);
...
int InitInterruptController(void) {
	int i;
	for(i = 0; i < BCM2837_INTC_TOTAL_IRQ; i++) {
